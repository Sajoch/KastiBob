...
struct qt_meta_stringdata_Trainer_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Trainer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Trainer_t qt_meta_stringdata_Trainer = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Trainer"
...
const QMetaObject Trainer::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Trainer.data,
      qt_meta_data_Trainer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Trainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Trainer.stringdata0))
