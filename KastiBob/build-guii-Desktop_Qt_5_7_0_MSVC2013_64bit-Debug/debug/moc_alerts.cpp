...
const QMetaObject Alerts::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Alerts.data,
      qt_meta_data_Alerts,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Alerts::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Alerts.stringdata0))
        return static_cast<void*>(const_cast< Alerts*>(this));
